...
# TABULATION:
<img width="1280" height="768" alt="image" src="https://github.com/user-attachments/assets/b86ea911-ce13-474c-84bd-f2d64e98e8a4" />
		

# Calculation:
1.	ma (Theory) = am/ac = 9.2/14.72 = 0.625
2.	ma(Practical) = (Emax-Emin)/(Emax+Emin) = 18.867/29.353 = 0.642
3.	Bw=2fmp = 2*1644.73 = 3289.46
